...
const page = () => { 
  ...
  return (
    <>
      <div className='h-4/5 p-5 py-20 gap-4 flex items-center justify-center bg-gradient-to-br from-teal-50 to-teal-400'>
        <div className='m-2'>
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-300 text-teal-800 text-sm font-medium mb-6\">
            <span className="w-2 h-2 rounded-full bg-teal-500 animate-pulse\"></span> AI-Powered Gastro Care Assistant
          </div>
          <div className='text-6xl font-bold'>
            Your AI Gastro Care Assistant
          </div>
          <div className='text-gray-600 p-3'>
            Get symptom guidance, medicine information, and medical answers instantly. Your trusted companion for gastro-related queries.
          </div>
          <div>
            <button onClick={handleSubmitChat} className="px-8 py-4 bg-gradient-to-r from-teal-500 to-teal-600 text-white rounded-xl font-semibold hover:from-teal-600 hover:to-teal-700 transition-all shadow-lg shadow-teal-500/25 flex items-center justify-center gap-2\">
      ...
      <div className="px-5 py-20 mt-10 bg-white">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto">Our AI-powered gastro care assistant provides reliable digestive health information and guidance.</p>
        </div>
        <div className='flex gap-5 p-2 items-center'>
          <div className="rounded-2xl bg-teal-50 hover:border-b-gray-500 p-6 text-center shadow-sm hover:shadow-lg transition-shadow duration-300">
            ...
            <p>
              Ask any gastro question and get instant, informative responses from our AI assistant.
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-teal-50 hover:border-b-gray-500 p-6 text-center shadow-sm hover:shadow-lg transition-shadow duration-300">
            ...
            <p>
              Describe your symptoms and receive guidance on possible gastro conditions and next steps.
            </p>
          </div>
      ...
      <section className="py-6 bg-amber-50 border-y border-amber-200\">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-start gap-4">
            ...
            <p id="disclaimer-display" className="text-amber-800 text-sm leading-relaxed"><strong>Gastro Care Disclaimer:</strong> This chatbot provides gastro information only and is not a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your gastroenterologist or other qualified health provider.</p>
          </div>
        </div>
      </section>
    </>
